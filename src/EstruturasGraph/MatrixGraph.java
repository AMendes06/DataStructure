...
import EstruturasLinkedStack.LinkedStack;

/**
 * Graph represents an adjacency matrix implementation of a graph4
 *
...
public class MatrixGraph<T> implements GraphADT<T> {
    ...
    protected boolean areConnected(int x, int y) throws ElementNotFoundException {
        if (x >= 0 && y >= 0 && x < this.numberVertices && y < this.numberVertices) {
    ...
    protected boolean areConnected(T vertex1, T vertex2) throws ElementNotFoundException {
